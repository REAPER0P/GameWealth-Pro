           ...
           <div className="bg-slate-900 border border-slate-800 p-10 rounded-[3rem] space-y-10 max-w-sm mx-auto shadow-2xl text-center backdrop-blur-md animate-in zoom-in duration-500">
              ...
              <div className="space-y-6 text-left">
                 <div className="space-y-2">
                    ...
                    <input type="number" defaultValue={5000} className="w-full bg-black border border-slate-800 rounded-2xl px-6 py-4 text-white font-orbitron focus:border-blue-500 outline-none transition-all focus:scale-[1.02] focus:shadow-lg focus:shadow-blue-500/20" />
                 </div>
                 <div className="space-y-2">
                    <label className="text-[10px] text-slate-500 font-bold uppercase tracking-widest px-2">Growth Reward (GEMS)</label>
                    <input type="number" defaultValue={50} className="w-full bg-black border border-slate-800 rounded-2xl px-6 py-4 text-white font-orbitron focus:border-blue-500 outline-none transition-all focus:scale-[1.02] focus:shadow-lg focus:shadow-blue-500/20" />
                 </div>
                 <button onClick={() => alert('Logic Matrix Updated')} className="w-full py-5 bg-blue-600 text-white rounded-2xl font-bold font-orbitron uppercase tracking-widest text-xs shadow-xl active:scale-95 transition-all shadow-blue-500/20 hover:scale-[1.02]">Apply Global Changes</button>
              </div>
           </div>
        )}
      </main>
